                        ...
                        <div class="row"> <div class="col-lg-12">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-dark-900 mb-4">Selamat Datang</h1>
                                </div>
                                <form class="user" method="POST" action="model/login/proseslogin.php">
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user"
                                        placeholder="Masukan User Name ..." name="username" required>
                                    </div>
                                    <div class="form-group">
                                        <input type="password" class="form-control form-control-user"
                                            ...
                                            <button class="btn btn-dark btn-user btn block">Masuk</button>
                                            <hr>
                                        </a>
                                    </form>
                                </div>
